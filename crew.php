...
<body >
    ...
    <section class="sectionBlock container">
        <h2 class="sectionTitle">High Board</h2>
        ...
        <div class="cardsGrid">
            ...
            <div class="boardItem">
                ...
                <img src="./assets/img/searchIcon.png" class="smallIcon" alt="" style="display:none;">
            </div>
            ...
            <div class="boardItem">
                ...
                <a href="#" class="btn btn-outline btn-sm">Discover More</a>
            </div>
            ...
            <div class="boardItem">
                ...
                <div class="flipCard">
                    <span class="sideLabel right">BD L</span>
                    <span class="sideLabel left purpleText">CR PR</span>
                    <div class="flipInner">
                        <div class="flipSide flipFront">
                            <img src="./assets/img/backCardCrew.png" />
                        </div>
