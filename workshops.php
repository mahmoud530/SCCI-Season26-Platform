...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@400;700&family=Irish+Grover&display=swap" rel="stylesheet">
    <!-- Icons -->
        ...
        <div class="container">
            <div class="workshop-cards-grid">
                ...
                <div class="workshop-card" onclick="window.location.href='workshopsDetails.php?id=techsolve'">
                    <img src="assets/img/techSolveCard.png" alt="TechSolve Workshop" class="card-bg" loading="lazy">
                ...
                <!-- Workshop Card 2: Season 26 Generic/Workshop -->
                <div class="workshop-card">
                    <img src="assets/img/marketiveCard.png" alt="Workshop Card" class="card-bg" loading="lazy">
                    <div class="card-content">
                        <a href="#" class="btn btn-primary btn-sm">Explore More</a>
                    </div>
                </div>

                <!-- Workshop Card 3: Season 26 Generic/Workshop -->
                <div class="workshop-card">
                    <img src="assets/img/dataAnalysisCard.png" alt="Workshop Card" class="card-bg" loading="lazy">
                    <div class="card-content">
                        <a href="#" class="btn btn-primary btn-sm">Explore More</a>
                    </div>
                </div>

                <!-- Workshop Card 4: Season 26 Generic/Workshop -->
                <div class="workshop-card">
                    <img src="assets/img/devolgyCard.png" alt="Workshop Card" class="card-bg" loading="lazy">
                    <div class="card-content">
                        <a href="#" class="btn btn-primary btn-sm">Explore More</a>
                    </div>
                </div>
